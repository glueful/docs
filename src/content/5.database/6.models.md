...
abstract class BaseRepository
{
    ...
    {
        return $this->db->table($this->table)->bulkInsert($records);
    }
...
class UserRepository extends BaseRepository
{
    ...
    public function create(array $data): string
    {
        ...
        $result = $this->db->table($this->table)->insert($filteredData);
    ...
    {
        return $this->db->transaction(function() use ($userData, $profileData) {
...
class AuditLogger
{
    ...
    public function logEvent(array $eventData): bool
    {
        ...
        return $this->db->table('audit_logs')->insert($eventData);
    }
