...
To create a new migration file, use the migrate:create command:

```bash
php glueful migrate:create create_table_name
```
...
Migrations can be run using the console commands:
