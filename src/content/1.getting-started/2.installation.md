...
### Method 1: Quick Setup with Install Command (Recommended)

The fastest way to set up a new Glueful project is using the built-in install command:
...
- Secure key generation (APP_KEY, JWT_KEY)
...
Visit `http://localhost:8000/api/status` to confirm your installation is working.

**Production Configuration (Optional):**

For production deployments, use the production configuration tools:
