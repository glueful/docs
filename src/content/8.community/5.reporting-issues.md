...
**Note**: There is a special issue template (`.github/ISSUE_TEMPLATE/security_vulnerability.md`) that redirects security reports to email to prevent public disclosure.
...
- Review the documentation at [docs.glueful.com](https://docs.glueful.com)
- Check similar closed issues for patterns and examples
...
4. **Security Vulnerability** (`.github/ISSUE_TEMPLATE/security_vulnerability.md`)
   - Redirects to secure email reporting
   - Explains responsible disclosure process

The templates are configured in `.github/ISSUE_TEMPLATE/config.yml` which also provides links to:
- Security email for vulnerabilities
- GitHub Discussions for community support
- Documentation site for self-help