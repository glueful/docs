...
5. Fill in the PR template (`.github/PULL_REQUEST_TEMPLATE.md`) which includes:
   - Description of changes
   - Type of change (bug fix, feature, breaking change, etc.)
   - Related issues
   - Testing performed
   - Checklist for code quality
   - Cross-repository change coordination if needed
   - Screenshots or command output for visual changes
...
Our PR template is located at `.github/PULL_REQUEST_TEMPLATE.md` and ensures all necessary information is provided. The template includes sections for:
...
- Check the [contributing documentation](/community/contributing) for more guidance
