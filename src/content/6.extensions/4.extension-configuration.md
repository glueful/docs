...
This section covers how to configure extensions in the Glueful framework v2.0. The new JSON-based configuration system provides comprehensive metadata, environment-specific settings, and powerful management capabilities.

## Configuration Files

Glueful v2.0 uses a centralized JSON-based configuration system for managing extensions.

### Main Extensions Configuration

Extensions are configured in the `extensions.json` file at the root of your Glueful application. This file contains comprehensive metadata and settings:
  ...
  "extensions": {
    "EmailNotification": {
      ...
      "provides": {
        ...
        "services": ["extensions/EmailNotification/src/ServiceProvider.php"],
        "routes": ["extensions/EmailNotification/routes.php"],
        "middleware": [],
        "commands": [],
        "migrations": []
      },
      "config": {
        "categories": ["notification", "core"],
        "publisher": "glueful",
        "icon": "extensions/EmailNotification/assets/icon.png"
      }
    }
  },
  "environments": {
