...
|-----------|--------|------|---------|-------------|
| EmailNotification | **Enabled** | Core | 1.0.0 | Provides email notification functionality |
| Admin | **Enabled** | Optional | 1.0.0 | Administrative interface for managing Glueful applications |
| RBAC | **Enabled** | Optional | 1.0.0 | Role-Based Access Control for managing user permissions |
| SocialLogin | **Disabled** | Optional | 1.0.0 | Social authentication through OAuth providers |
...
The Admin Dashboard extension provides a comprehensive management interface for your Glueful application. This extension is currently **enabled** and actively running.
...
- **RBAC Integration**: Role and permission management when RBAC extension is enabled

### Routes

The Admin extension registers the following routes:

- `GET /admin` - Admin dashboard homepage
- `GET /admin/extensions` - Extension management interface
- `GET /admin/users` - User management
- `GET /admin/system` - System information
- `GET /admin/database` - Database statistics
- `GET /admin/api-metrics` - API performance metrics
...
- **EmailNotification**: For system alert emails
- **Database Layer**: For statistics and monitoring
- **Extension System**: For extension management
