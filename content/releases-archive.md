...
description: Full release notes for Glueful versions v1.49.1 and earlier.
---

Release notes for older versions (v1.49.1 and earlier). For the latest releases and the complete version table, see [Release Notes](/releases).
