...
::div{class="border-y border-gray-200/70 dark:border-white/10 bg-gray-50/60 dark:bg-white/5"}
  <div data-reveal class="mx-auto max-w-5xl px-6 py-5 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-gray-600 dark:text-gray-300">
    ...
    <span class="inline-flex items-center gap-2"><span class="i-lucide-blocks h-4 w-4 text-gray-400 dark:text-gray-500"></span> 13 official extensions</span>
...
<section class="border-t border-gray-200/70 dark:border-white/10">
  <div class="mx-auto w-full max-w-(--ui-container) px-6 py-20 sm:py-24">
    <div data-reveal-stagger class="reveal-cards grid grid-cols-1 overflow-hidden rounded-2xl border border-gray-200/80 bg-gray-200/70 dark:border-white/10 dark:bg-white/10 lg:grid-cols-3 lg:gap-px">
...
:::div{class="mx-auto grid w-full max-w-(--ui-container) grid-cols-1 lg:grid-cols-5 lg:items-stretch" data-reveal-stagger}
...
#title
<span data-reveal class="block text-left w-full text-3xl sm:text-4xl lg:text-5xl tracking-tight font-semibold text-highlighted">What you get immediately</span>
...
:::div{class="reveal-cards mx-auto mt-4 grid max-w-(--ui-container) grid-cols-1 gap-px overflow-hidden rounded-2xl border border-gray-300 bg-gray-300 dark:border-white/15 dark:bg-white/15 sm:grid-cols-2 lg:grid-cols-3" data-reveal-stagger}
...
#title
<span data-reveal class="text-3xl sm:text-4xl lg:text-5xl tracking-tight font-semibold text-highlighted block text-left w-full">Grow with official extensions</span>
...
:::div{class="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-6 py-20 sm:py-24 lg:grid-cols-2 lg:gap-16" data-reveal-stagger}
