...
description: Validate and normalize service configuration with Glueful’s internal OptionsResolver
---


## Overview

Glueful provides an internal OptionsResolver (SimpleOptionsResolver) for robust configuration validation. This delivers type-safe configuration with validation, normalization, and sensible defaults across services without requiring Symfony’s OptionsResolver.
