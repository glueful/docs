...
description: Gate, voters, policies, and attributes for robust authorization with PermissionManager integration.
---
...
```php
return [
    'super_roles' => ['admin'], // Option A: treat admin as super role

    // Option B: explicitly allow role tokens for RoleVoter to grant
    'roles' => [
        'admin' => ['*', 'role.admin'],
        'editor' => ['role.editor'],
    ],
...
- [Authentication](/essentials/authentication) - User authentication and sessions
- [Middleware Development](/cookbook/middleware) - Creating custom middleware
- [Dependency Injection](/advanced/dependency-injection) - Service container and providers
- [Configuration](/cookbook/configuration) - Framework configuration
