...
- `loadMigrationsFrom(string $dir, int $priority = MigrationPriority::DEFAULT, ?string $source = null)` - Register migration directory (order with `MigrationPriority`: `FOUNDATION` -200, `IDENTITY` -100, `DEFAULT` 0, `DEPENDENT` 100)  
