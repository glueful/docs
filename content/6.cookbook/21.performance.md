...
- **Cache** (`config/cache.php`)
  ...
  - Tags: `cache.enable_tags` (Redis by default), `tags_store`
...
Prefer environment-aware toggles via `env()` (stricter limits in production), and validate with load testing after changes.
